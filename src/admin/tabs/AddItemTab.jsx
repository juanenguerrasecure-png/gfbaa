    ...
    <div className={styles.wrap}>
      ...
      {activeTab === 'batch' ? (
        ...
        <div>
          ...
          <form onSubmit={handleWholesaleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              {/* Product Identity */}
              <div className="bg-white p-6 rounded-lg border border-stone-200 shadow-sm space-y-4">
                <h3 className="font-display text-lg text-stone-900 border-b border-stone-100 pb-2">1. Product Identity</h3>
              ...
              <div className="bg-white p-6 rounded-lg border border-stone-200 shadow-sm space-y-4">
                <div className="flex items-center justify-between border-b border-stone-100 pb-2">
                  <h3 className="font-display text-lg text-stone-900">2. Batch Acquisition Logistics</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1">
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full p-2 bg-white border border-stone-300 rounded text-sm text-stone-800 outline-none focus:border-amber-500"
                      placeholder="e.g. CHAN-MAY-2024 (Auto-generated if blank)"
            ...
            <div className="space-y-6">
              <div className="bg-stone-900 text-stone-100 p-6 rounded-lg border border-stone-950 shadow-md space-y-4 sticky top-6">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-stone-900 font-semibold rounded-lg text-sm transition-all shadow-md flex items-center justify-center gap-2 mt-6"
                >
                  <PlusCircle size={16} />
                  Log Purchase & Batch
                </button>
          ...
          {activeBatches.length === 0 ? (
            <div className="bg-amber-50 text-amber-900 rounded-lg p-8 border border-amber-200 text-center space-y-3">
              ...
              <button
                type="button"
                onClick={() => setActiveTab('batch')}
                className="px-4 py-2 bg-stone-900 text-white rounded text-xs font-semibold hover:bg-stone-800 transition-all"
              >
                Go Register Batch
              </button>
            </div>
          ) : (
            <form onSubmit={handleRetailSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-6">
                {/* Batch Association */}
                <div className="bg-white p-6 rounded-lg border border-stone-200 shadow-sm space-y-4">
                  <h3 className="font-display text-lg text-stone-900 border-b border-stone-100 pb-2">1. Select Acquisition Batch</h3>
                ...
                {catalogItemForm.batchId && (
                  <div className="bg-white p-6 rounded-lg border border-stone-200 shadow-sm space-y-4">
                    <h3 className="font-display text-lg text-stone-900 border-b border-stone-100 pb-2">2. Storefront Custom Customization</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="sm:col-span-2 flex flex-col gap-1">
                        ...
                        <textarea
                          ...
                          placeholder="e.g. Hand-picked directly from European distributors. Mint condition with authenticity cards and dust bag included."
              ...
              <div className="space-y-6">
                <div className="bg-stone-900 text-stone-100 p-6 rounded-lg border border-stone-950 shadow-md space-y-4 sticky top-6">
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-amber-500 hover:bg-amber-600 active:bg-amber-700 text-stone-900 font-semibold rounded-lg text-sm transition-all shadow-md flex items-center justify-center gap-2 mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <PlusCircle size={16} />
